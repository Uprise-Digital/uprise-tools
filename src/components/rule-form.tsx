...
export function RuleForm({ accounts, team }: Props) {
  ...
  const symbol =
    metric === "cost_per_conversion" || metric === "cost"
      ? "$"
      : metric.includes("ctr")
        ? "%"
        : "";
    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select the Google Ads client account to monitor.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Define the exact threshold that will trigger the alarm.
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={setMetric} required>
              ...
              <SelectContent>
                ...
                <SelectItem value="cost_per_conversion">
                  CPA (Cost per Conv.)
                </SelectItem>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            When should we run this check, and over what historical data?
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Who should receive the Resend email when this rule trips?
          </CardDescription>
        </CardHeader>
              ...
              <Checkbox
                ...
                onCheckedChange={(checked) => {
                  if (checked) setNotifyUserIds([...notifyUserIds, member.id]);
                    ...
                    setNotifyUserIds(
                      notifyUserIds.filter((id) => id !== member.id),
                    );
                }}
              />
              <Label
      ...
      <div className="flex justify-end gap-4">
        ...
        <Button type="submit" disabled={loading}>
          {loading ? "Saving..." : "Create Alert Rule"}
        </Button>
      </div>
    </form>
  );
