  ...
  try {
    ...
    const sanitizedSettings = onboardingSettings
      ? {
          ...
          mondayBoardId: onboardingSettings.mondayBoardId,
          autoSyncNewAccounts: onboardingSettings.autoSyncNewAccounts,
          autoSyncScope: onboardingSettings.autoSyncScope,
          broadKeywordsEnabled: onboardingSettings.broadKeywordsEnabled,
          phraseKeywordsEnabled: onboardingSettings.phraseKeywordsEnabled,
          exactKeywordsEnabled: onboardingSettings.exactKeywordsEnabled,
