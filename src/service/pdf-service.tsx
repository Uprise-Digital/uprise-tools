    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.section}>
        <View>
          ...
          <Text style={styles.bodyText}>{data.ai.summary}</Text>
      ...
      <View style={styles.section}>
        <View>
          ...
          <Text style={styles.bodyText}>
            A granular look at the search terms driving your performance. We
            continuously optimize keyword bidding and match types to ensure your
            budget is allocated to the highest-converting searches.
          </Text>
        </View>
