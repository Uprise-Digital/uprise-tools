          ...
          <Card className="py-0 border-slate-200 shadow-sm">
            ...
            <CardContent className="p-5 space-y-6">
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-0.5">
                  <div className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
                    <ActivitySquare className="w-3.5 h-3.5 text-indigo-600" />{" "}
                    Agency God-View
                  </div>
                  <p className="text-[10px] text-slate-500 max-w-[180px]">
                    Allows Claude to pull the macro portfolio metrics and triage
                    critical fires.
                  </p>
                </div>
                <Switch
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-0.5">
                  <div className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
                    <ActivitySquare className="w-3.5 h-3.5 text-blue-600" />{" "}
                    Campaign Diagnostics
                  </div>
                  <p className="text-[10px] text-slate-500 max-w-[180px]">
                    Allows Claude to dive deep into a specific account's keyword
                    and PMax performance.
                  </p>
                </div>
                <Switch
                  ...
                  disabled={isSavingTools}
                  onCheckedChange={(c) =>
                    handleToggleTool("campaignDiagnostics", c)
                  }
                />
              </div>
            </CardContent>
