...
import {
    Sparkles, TrendingUp, TrendingDown, Minus, Zap, BarChart2,
    Target, AlertTriangle, ChevronRight, Loader2, Clock, RefreshCw, Database
} from "lucide-react";
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-4">
                        {[
                            ...
                            <div key={i} className="rounded-lg bg-slate-50 border border-slate-200 px-3 py-2.5 text-center overflow-hidden">
