...
export default async function MccSelectPage({
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 text-slate-900 dark:text-white transition-colors relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 backdrop-blur-xl p-6 sm:p-8 rounded-2xl shadow-xl dark:shadow-2xl relative transition-all duration-300">
        <MccSelectClient
          connectionId={connId}
          orgId={orgId}
