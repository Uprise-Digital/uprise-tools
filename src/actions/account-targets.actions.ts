...
export async function saveAccountTargetsAction(
    ...
    try {
        ...
        await db
            .update(adAccounts)
            .set({
                targetCpa: payload.targetCpa !== null ? String(payload.targetCpa) : null,
                targetRoas: payload.targetRoas !== null ? String(payload.targetRoas) : null,
                monthlyBudgetCap: payload.monthlyBudgetCap !== null ? String(payload.monthlyBudgetCap) : null,
